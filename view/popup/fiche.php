	<div class="content3">
			<h3 class="page-title">
				...
				$statut = isset($_SESSION['STATUT_PARTICULIER'][$this->vars['statut_particulier']]) ? $_SESSION['STATUT_PARTICULIER'][$this->vars['statut_particulier']] : '' ;
				$sous_statut = isset($_SESSION['SOUS_STATUT_PARTICULIER'][$this->vars['sous_statut']]) ? $_SESSION['SOUS_STATUT_PARTICULIER'][$this->vars['sous_statut']] : '' ;

				echo $civilite . ' ' .$this->vars['firstName'] . ' ' . $this->vars['lastName'] . ' I ' . ' ' . $statut . ' ' .$sous_statut .  ' n° ' . $this->request->params[0] . ' <small> I Créée le ' . lof::convertDateFromAdobeFormat($this->vars['created']) . ((strlen($this->vars['conseiller']) > 0) ? ' Par ' . $this->vars['conseiller'] : '') . ' , Modifiée le ' . lof::convertDateFromAdobeFormat($this->vars['lastModified']) . '</small> ' ;
				?>
            </h3>
                            ...
                            <div class="form-horizontal" role="form">
                                <div class="form-body">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="Num_INSEE" maxlength="13" class="form-control" value="<?php if (isset($this->vars['num_insee'])) echo $this->vars['num_insee']; ?>" <?php if(isset($this->vars['num_cotisant']) && strlen($this->vars['num_cotisant'] && $this->vars['statut_particulier'] == "3")) echo "readonly";?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Date de Naissance<?php if(!isset($_SESSION['statut_particulier']) || $this->vars['statut_particulier'] != 1) {?>&nbsp;<span style="font-size : 12px; color : red"> * </span><?php } ?></label>
