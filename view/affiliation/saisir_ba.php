	<div class="content3">		
		  ...
		  <form class="login-form" method="post" action="<?php echo Router::url('affiliation/saisir_ba/'.$this->request->params[0]); ?>" style="z-index:0;margin-top:10px; position:relative">
		   
			<h3 class="page-title">
				Affiliation > saisie du BA > particulier n° <?php echo $this->request->params[0];?>
            </h3>

		    <div class="row">
				<div class="col-md-6"  style="margin-bottom : 10px" align="left">
					<a class="btn btn-success imprimer_precompte" style="<?php echo (isset($this->vars['MODE_REGLEMENT_RETRAITE_COTISANT_Id']) && $this->vars['MODE_REGLEMENT_RETRAITE_COTISANT_Id'] != 3) ? 'display:none' : '';?>">Imprimer précompte</a>
					<a class="btn btn-danger" href="<?php echo Router::url('affiliation/result') ?>">Retourner à la liste</a>
				</div>
			
				<div class="col-md-6"  style="margin-bottom : 10px" align="right">
					<button class="btn btn-info" type="submit" name="enregistrer">Enregistrer</button>
					<a class="btn btn-success valider" name="valider">Valider</a>
				</div>
			</div>
						...
						<div class="portlet-body col-md-12">
							<div class="form-horizontal  col-md-6" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
											<?php 
											$civilite_conjoint = ($this->vars['qualite_id_conjoint'] > 0 && $this->vars['qualite_id_conjoint'] <= 2) ? (strtoupper($_SESSION['CIVILITE'][$this->vars['qualite_id_conjoint']])) . ' ' : ('');
											?>
						...
						<div class="portlet-body col-md-12">
							<div class="form-horizontal  col-md-6" role="form">
								<div class="form-group">
									...
									<div id="mois_prelevement" class="form-group" style="<?php if($this->vars['MODE_REGLEMENT_RETRAITE_COTISANT_Id'] > 7 || $this->vars['MODE_REGLEMENT_RETRAITE_COTISANT_Id'] < 4) echo "display:none"?>">
			...
			<input id="valider" type="hidden" />
			

		    <div class="row">
				<div class="col-md-6"  style="margin-bottom : 10px" align="left">
					<a class="btn btn-success imprimer_precompte" style="<?php echo (isset($this->vars['MODE_REGLEMENT_RETRAITE_COTISANT_Id']) && $this->vars['MODE_REGLEMENT_RETRAITE_COTISANT_Id'] != 3) ? 'display:none' : '';?>">Imprimer précompte</a>
					<a class="btn btn-default" href="<?php echo Router::url('affiliation/result') ?>">Retourner à la liste</a>
				</div>
			...
			<div id="saisie_affiliation" class="modal fade" data-keyboard="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>
								Voulez-vous valider la saisie du bulletin d'affiliation ?
							</p>
						</div>
						<div class="modal-footer">
							<button  data-dismiss="modal" class="btn btn-default">Non</button>
							<button id="validation_saisie" class="btn btn-success">Oui</button>
						</div>
					</div>
				</div>
			...
			<div id="no_print" class="modal" data-keyboard="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						...
						<div class="modal-body">
							<p>
								Veuillez sauvegarder les information avant d'imprimer la demande de précompte.
							</p>
						</div>
						<div class="modal-footer">
