...
<!-- BEGIN CONTENT -->
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
           ...
           <form class="login-form" method="post" action="<?php echo Router::url('recipient/create'); ?>" style="z-index:0;margin-top:10px; position:relative" readonly>


		   <div class="row">
				<div class="col-md-12" style="text-align:right" ><button id="valid" class="btn btn-success" style="margin-bottom : 10px" type="submit">Créer</button></div>
				</div>
		   ...
		   <div class="row ">
                                ...
                                <div class="form-body">
									...
									<div class="col-md-8">
											<div class="input-group date date-picker">
												<input id="Date_Naissance" name="tsBirth" type="texte" class="form-control">
                                        ...
                                        <div class="col-md-8">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <input type="radio" name="Code_VIP" value="1"> Oui </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="Code_VIP" value="0" checked> Non </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
											<select  name="SITUATION_PROFESSIONNELLE_Id" class="form-control">
                                                ...
                                                <?php foreach($_SESSION['CORPS'] as $cle => $valeur) {?>
								...
								<div id="affiliation_div" style="display:none">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="Administration_CP" type="text" class="form-control" name="Administration_CP" pattern="[0-9]{5}" value="<?php if (isset($this->vars['Admin_Code_Postal'])) echo $this->vars['Admin_Code_Postal']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <label class="col-md-4 control-label">Complément Nom</label>
                                        <div class="col-md-8">
                                            <input id="Administration_Adresse_1" type="text" class="form-control" name="Administration_Adresse_1" value="<?php if (isset($this->vars['Admin_Adresse_2'])) echo $this->vars['Admin_Adresse_2']; ?>" >
                                        </div>
                                    </div>
								    ...
								    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="Administration_Adresse_2" type="text" class="form-control" name="Administration_Adresse_2" value="<?php if (isset($this->vars['Admin_Adresse_3'])) echo $this->vars['Admin_Adresse_3']; ?>" >
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input id="Administration_Adresse_3" type="text" class="form-control" name="Administration_Adresse_3" value="<?php if (isset($this->vars['Admin_Adresse_1'])) echo $this->vars['Admin_Adresse_1']; ?>">
                                        </div>
                                    </div>
			...
			<div class="form-horizontal" role="form">
				...
				<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <input type="radio" name="Occupation_Logement" value="Propriétaire"> Propriétaire </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="Occupation_Logement" value="Locataire"> Locataire </label>
									...
									<div class="form-group">
                                        <label class="col-md-4 control-label">Propriétaire locatif</label>
                                        <div class="col-md-8">
                                            <div class="radio-list">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
											<select  name="Tranche_revenu" class="form-control"> 
												...
												<option value="< 600 euros mensuels net">&lt;&nbsp;600 euros mensuels net</option>
												<option value="600 à 1 699">600 à 1 699</option>
												<option value="1 700 à 2 899">1 700 à 2 899</option>
												<option value="2 900 à 4 099">2 900 à 4 099</option>
												<option value=">= 4100"> &gt;&equals;&nbsp; 4100</option>
											</select>
										</div>
                                    </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal" role="form">
                                <div class="form-body">
                                    ...
                                    <label class="col-md-4 control-label">Complément Nom</label>
                                        <div class="col-md-8">
                                            <input id="Adresse_1" type="text" class="form-control" name="Adresse_1" value="<?php if (isset($this->vars['Adresse_2'])) echo $this->vars['Adresse_2']; ?>" >
                                        </div>
                                    </div>
								    ...
								    <div class="form-group">
                                        <label class="col-md-4 control-label">Complément Localisation</label>
                                        <div class="col-md-8">
                                            <input id="Adresse_2" type="text" class="form-control" name="Adresse_2" value="<?php if (isset($this->vars['Adresse_3'])) echo $this->vars['Adresse_3']; ?>" >
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        <label class="col-md-4 control-label">N° et libellé de la voie</label>
                                        <div class="col-md-8">
                                            <input id="Adresse_3" type="text" class="form-control" name="Adresse_3" value="<?php if (isset($this->vars['Adresse_1'])) echo $this->vars['Adresse_1']; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="form-body">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <input class="ziza" type="radio" name="Optin_Prefon_Courrier" value="0" checked> Oui </label>
                                                <label class="radio-inline">
                                                    <input class="ziza" type="radio" name="Optin_Prefon_Courrier" value="1"> Non </label>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <input type="radio" name="Optin_Prefon_Email" value="0" checked> Oui </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="Optin_Prefon_Email" value="1"> Non </label>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <input type="radio" name="Optin_Prefon_Telephone" value="0"checked> Oui </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="Optin_Prefon_Telephone" value="1"> Non </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <input type="radio" name="Optin_Prefon_SMS" value="0" checked> Oui </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="Optin_Prefon_SMS" value="1"> Non </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <input type="radio" name="Optin_Partenaires" value="0" checked> Oui </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="Optin_Partenaires" value="1"> Non </label>
                                            </div>
                                        </div>
                                    </div>
			...
			<div class="row"> 
				<div class="col-md-12" style="text-align:right"><button class="btn btn-success" style="margin-top : 10px" type="submit">Créer</button></div>
			</div>
