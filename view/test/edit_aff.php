<div class="content3">
    ...
    <!-- BEGIN SEARCH FORM -->
	       <form class="login-form" method="post" action="<?php echo serveur_url.DS ?>recipient/test" style="z-index:0;margin-top:10px; position:relative">
		   <div class="row">
				<div class="col-md-12" style="text-align:right" ><button id="valid" class="btn btn-success" style="margin-bottom : 10px" type="submit">Valider la saisie</button></div>
			</div>
		   <div class="row ">
				<div class="col-md-12">
    ...
    <!-- END SEARCH FORM -->
		<div class="row">
			...
			<div class="row"> 
				<div class="col-md-12" style="text-align:right"><button class="btn btn-success" style="margin-top : 10px" type="submit">Valider la saisie</button></div>
			</div>				
